      ...
      <main>
        <section className="hero">
          <div className="hero__copy">
            ...
            <p>{isRu ? 'Понятные уроки, настоящая практика и личный помощник Echo — на русском или казахском языке.' : 'Түсінікті сабақтар, шынайы тәжірибе және Echo жеке көмекшісі — қазақ немесе орыс тілінде.'}</p>
